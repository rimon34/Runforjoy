...
public class Constants {
    ...
    public static final int LEVEL_UP_SCORE = 1000;
    public static final float BASE_SPAWN_DELAY = 1.2f;
    public static float SPAWN_DELAY = BASE_SPAWN_DELAY;  // Now changeable
    public static final float BASE_OBJECT_SPEED = 220f;
    public static final float MAX_OBJECT_SPEED = 700f;
